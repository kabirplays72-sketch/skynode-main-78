...
def styles():
    return _no_cache(send_from_directory(BASE_DIR, "styles.css"))


@app.route("/script.js")
def script():
    return _no_cache(send_from_directory(BASE_DIR, "script.js"))


@app.route("/extra.js")
def extra_script():
    return _no_cache(send_from_directory(BASE_DIR, "extra.js"))
